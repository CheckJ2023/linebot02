...
public class LineWebHookLibrary{
    ...
    //         {
    //             string text = "";
    //             using (StreamReader streamReader = new(base.Request.Body, Encoding.UTF8))
    //             {
    //                 text = streamReader.ReadToEndAsync().Result;
    //             }

    //             PostData = text;
    //             receivedMessage = Utility.Parsing(text);
    //         }
    ...
    public ReceivedMessage GetReceivedMessage(HttpRequest request)
    {
        string text = "";
